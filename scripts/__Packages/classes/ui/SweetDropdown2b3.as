class classes.ui.SweetDropdown2b3
{
   var __autoSelect;
   var baseFont;
   var itemFont;
   ...
   function SweetDropdown2b3(p, baseGraphicToLoad, baseFontToLoad, itemFontToLoad, scrollHeight, scrollOffset, autoSelect, itemWidth, itemHeight)
   {
      ...
      classes.ui.SweetDropdown2b3.pruneDropdownCollection();
      classes.ui.SweetDropdown2b3.dropdownCollection.push(this);
      this.init();
      trace("dropdownCollection...");
      trace(classes.ui.SweetDropdown2b3.dropdownCollection);
   }
   ...
   static function pruneDropdownCollection()
   {
      ...
      for(var _loc1_ in classes.ui.SweetDropdown2b3.dropdownCollection)
      {
         trace(classes.ui.SweetDropdown2b3.dropdownCollection[_loc1_].baseMovie.toString());
         if(classes.ui.SweetDropdown2b3.dropdownCollection[_loc1_].baseMovie.toString() == undefined)
         {
            trace("destroyed");
            classes.ui.SweetDropdown2b3.dropdownCollection[_loc1_].destroy();
         }
      }
   }
   function init()
   ...
   {
      for(var _loc2_ in classes.ui.SweetDropdown2b3.dropdownCollection)
      {
         if(classes.ui.SweetDropdown2b3.dropdownCollection[_loc2_] != sd)
         {
            classes.ui.SweetDropdown2b3.dropdownCollection[_loc2_].closeItems();
         }
      }
   }
   ...
   function destroy()
   {
      var _loc2_ = classes.ui.SweetDropdown2b3.dropdownCollection.length;
      var _loc3_ = 0;
      while(_loc3_ < _loc2_)
      {
         if(classes.ui.SweetDropdown2b3.dropdownCollection[_loc3_] == this)
         {
            classes.ui.SweetDropdown2b3.dropdownCollection.splice(_loc3_,1);
            _loc2_ -= 1;
         }
         _loc3_ += 1;
      }
