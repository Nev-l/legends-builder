class classes.ui.SweetDropdown2b
{
   var __autoSelect;
   var baseFont;
   var itemFont;
   ...
   function SweetDropdown2b(p, baseGraphicToLoad, baseFontToLoad, itemFontToLoad, scrollHeight, scrollOffset, autoSelect, itemWidth, itemHeight)
   {
      ...
      classes.ui.SweetDropdown2b.pruneDropdownCollection();
      classes.ui.SweetDropdown2b.dropdownCollection.push(this);
      this.init();
      trace("dropdownCollection...");
      trace(classes.ui.SweetDropdown2b.dropdownCollection);
   }
   ...
   static function pruneDropdownCollection()
   {
      ...
      for(var _loc1_ in classes.ui.SweetDropdown2b.dropdownCollection)
      {
         trace(classes.ui.SweetDropdown2b.dropdownCollection[_loc1_].baseMovie.toString());
         if(classes.ui.SweetDropdown2b.dropdownCollection[_loc1_].baseMovie.toString() == undefined)
         {
            trace("destroyed");
            classes.ui.SweetDropdown2b.dropdownCollection[_loc1_].destroy();
         }
      }
   }
   function init()
   ...
   function buildScroller()
   {
      ...
      this.scrollMC._y = this.__scrollOffset + this.__baseGraphicHeight / 2;
      ...
      this.mask._y = this.__baseGraphicHeight / 2;
      this.mask.clear();
      this.mask.beginFill(0,100);
      this.mask.moveTo(0,this.__scrollOffset);
      this.mask.lineTo(this.__itemWidth + 3 + this.__scrollWidth,this.__scrollOffset);
      this.mask.lineTo(this.__itemWidth + 3 + this.__scrollWidth,this.__scrollHeight + this.__scrollOffset);
      this.mask.lineTo(0,this.__scrollHeight + this.__scrollOffset);
      this.mask.lineTo(0,this.__scrollOffset);
      this.mask.endFill();
   ...
   {
      for(var _loc2_ in classes.ui.SweetDropdown2b.dropdownCollection)
      {
         if(classes.ui.SweetDropdown2b.dropdownCollection[_loc2_] != sd)
         {
            classes.ui.SweetDropdown2b.dropdownCollection[_loc2_].closeItems();
         }
      }
   }
   ...
   function createItemBlock(theIndex, itemText, showScroller)
   {
      ...
      _loc6_.createTextField("itemText",_loc6_.getNextHighestDepth(),5,2,150,30);
   ...
   function destroy()
   {
      var _loc2_ = classes.ui.SweetDropdown2b.dropdownCollection.length;
      var _loc3_ = 0;
      while(_loc3_ < _loc2_)
      {
         if(classes.ui.SweetDropdown2b.dropdownCollection[_loc3_] == this)
         {
            classes.ui.SweetDropdown2b.dropdownCollection.splice(_loc3_,1);
            _loc2_ -= 1;
         }
         _loc3_ += 1;
      }
