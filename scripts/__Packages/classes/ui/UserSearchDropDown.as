class classes.ui.UserSearchDropDown
{
   var classType;
   var _cbMovie;
   var dropDownMenu;
   ...
   function UserSearchDropDown(p, baseGraphicToLoad, baseFontToLoad, itemFontToLoad, scrollHeight, scrollOffset, autoSelect, itemWidth, itemHeight, cbMovie, a_classType)
   {
      this.classType = a_classType;
      this.enableSearchResults(true);
      this._cbMovie = cbMovie;
      this.dropDownMenu = new classes.ui.TextSelectDropDown(p,baseGraphicToLoad,baseFontToLoad,itemFontToLoad,scrollHeight,scrollOffset,autoSelect,itemWidth,itemHeight);
      ...
      this.dropDownMenuTextListener.onTextChanged = function(searchString)
      {
         ...
         if(!this._intervalID)
         {
            this._intervalID = setInterval(this.menu,"checkForTextChange",2000);
         }
      };
