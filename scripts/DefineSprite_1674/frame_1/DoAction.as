...
var txtStats4 = "";
var txtWinner = "";
var bet = Number(_global.chatObj.raceObj.bt);
if(!bet)
{
   bet = 0;
}
...
if(_global.chatObj.wid == r1Obj.id)
{
   ...
   nCarXML = new XML(_global.chatObj.twoRacersCarsXML.firstChild.childNodes[1]);
   txtWinner = "\r";
}
else if(_global.chatObj.wid == r2Obj.id)
{
   ...
   nCarXML = new XML(_global.chatObj.twoRacersCarsXML.firstChild.childNodes[0]);
   txtWinner = "\r\r";
}
if(rObj.un)
{
