...
{
   scListXML = new XML();
   scListXML.ignoreWhite = true;
}
scListXML.onLoad = function(success)
{
   trace("scListXML: " + success);
   ...
   if(success)
   {
      ...
      while(_loc8_ < _loc5_)
      {
         ...
         else
         {
            ...
            _loc10_.txtCol1 = _loc9_.sc;
            _loc10_.txtCol2 = classes.Lookup.getSCName(Number(_loc9_.sc));
         }
         if(_loc11_ != _loc7_)
         {
            _loc6_ = _loc8_ + 1;
